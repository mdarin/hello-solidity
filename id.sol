...
/*
Реализовать смарт контракт визитки: Данный смарт контракт должен содержать mapping, где ключом будет являться номер телефона, а значением имя и фамилия, а также функцию, с помощью которой можно добавлять записи в этот маппинг, или изменять уже существующие данные. Данную функцию должен иметь возможность вызывать только владелец контракта
*/
